...
|-----------|---------------|--------|-----------|---------|
| **Mapcraft (Illustrious v1)** | `Mapcraft_Illustrious_v1.safetensors` | 0.45 | fantasy 全般 | [799901](https://civitai.com/models/799901) |
| **Topdown Sci-Fi** | `Topdown_Map_Assets_SciFi.safetensors` | 0.50 | cyberpunk, scifi | [815019](https://civitai.com/models/815019) |
| **Fantasy Map Heavy** | `Fantasy_Map_Heavy.safetensors` | 0.55 | fantasy, postapoc 転用 | [382959](https://civitai.com/models/382959) |

- **必ず Illustrious v1 または SDXL v1 を選ぶ**（Anima / Flux 版は現行 workflow 非対応）
- Mapcraft trigger: `mapcraft, top-down view, from above, no humans`
...
| `TA_CONTROL_NET` | SDXL Canny の正確なファイル名 | |

### VS Code 設定

```json
{
  "textAdventure.imageGen.controlNet": "diffusion_pytorch_model_sdxl_canny.safetensors",
  "textAdventure.imageGen.mode": "illustrious"
}
```
