...
Do not require independent review, full suite, or durable audit reports.
...
* Do not automatically separate implementation, verification, and integration into different chats.
