...
| ID | 名称 | 状態 | 想定 Ver |
|----|------|------|----------|
| **F7** | 謁見の間（Audience Hall・陳情裁定） | **エンジン ✅ v1.39.10**（UI は D3 待ち） | 1.41.0（UI） |
| **F8** | 隣国ライバル領主（Rival Lords tick） | **エンジン ✅ v1.39.11**（UI は D3 待ち） | 1.42.0（UI） |
| **F9** | 主命・派遣（Officer Missions） | **エンジン ✅ v1.39.12**（UI は D3 待ち） | 1.43.0（UI） |
| **F10** | 合戦リゾルバ（Mass Battle） | **エンジン ✅ v1.39.13**（UI は D3 待ち） | 1.44.0（UI） |
