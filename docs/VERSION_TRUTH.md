...
|------|-----|
| `package.json` | **1.45.3** |
| CHANGELOG 先頭 | **[1.45.3]** discoveryOps commit ordering + agentic parse |
| Campaign Kit | Phase A presets + Phase B `discoveries.json` · `scrapbound-settlement` sample |
...
| テスト | `npm test` **126/126**（`check_version_consistency.js` 含む） |