...
|------|-----|
| `package.json` | **1.54.0** |
| CHANGELOG 先頭 | **[1.54.0]** 複数台帳整合性 — campaign resources 初期値 / sell_discovery 台帳検証 / commitGameState 結果で ledger ゲート |
...
| テスト | `npm test` **134/134**（`check_version_consistency.js` 含む） |