...
| `package.json` | **1.82.3** |
| CHANGELOG 先頭 | **[1.82.3]** Debug sandbox fast-path and gameplay request boundary repair |
...
| テスト | `npm test` expects **247/247**; human smoke is deferred until playable-v0 UI polish is integrated |
