...
|------|-----|
| `package.json` | **1.86.0** |
| CHANGELOG 先頭の版番号付きセクション | **[1.86.0]** |

Version decision: minor; 1.85.3 → 1.86.0。外部地図取込・表示調整・主人公マーカー設定という新しい操作経路を含む候補です。配布版ではありません。候補の exact SHA・起動元はPR #138と引き渡し記録を参照してください。
