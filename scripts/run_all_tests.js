...
const MANIFEST = [
    ...
    { category: 'unit', file: 'test_settlement_location_resolve_core.js' },
    { category: 'unit', file: 'test_settlement_location_resolve_host.js' },
    { category: 'unit', file: 'test_worldview_location_scoped_settlement.js' },
    ...
    { category: 'unit', file: 'test_gameplay_spine_vehicle_repair_commit.js' },
    { category: 'unit', file: 'test_gameplay_spine_vehicle_repair_ingress.js' },
    { category: 'unit', file: 'test_vehicle_state_document_v2_core.js' },
    { category: 'unit', file: 'test_vehicle_state_document_owner.js' },
    { category: 'unit', file: 'test_vehicle_state_document_owner_durability.js' },
    { category: 'unit', file: 'test_vehicle_state_writer_coordination.js' },
    ...
    { category: 'unit', file: 'test_prompt_budget_shadow_integration.js' },
    ...
    { category: 'unit', file: 'test_gameplay_input_fastpath.js' },
    ...
    { category: 'unit', file: 'test_economy_flow_core.js' },
    ...
    { category: 'unit', file: 'test_test_console.js', timeoutMs: 120000 },
    {
        category: 'simulation',
