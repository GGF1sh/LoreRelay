...
assert.strictEqual(style('blocked').statusKey, 'blocked', '6 geometry conflict cannot replace factual status');
assert.strictEqual(style('blocked').geometryConflicted, true, '6b geometry conflict remains an independent diagnostic');
assert.strictEqual(style('blocked').operational, false, '6c conflicted blocked route remains stopped');
