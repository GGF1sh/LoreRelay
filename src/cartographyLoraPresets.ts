...
/** Verified Civitai candidates for Illustrious XL / SDXL + Canny. Download Illustrious or SDXL variant — not Anima. */
export const CARTOGRAPHY_LORA_PRESETS: readonly CartographyLoraPreset[] = [
    {
        ...
        loraFileHint: 'Mapcraft_Illustrious_v1.safetensors',
        weight: 0.45,
        ...
        notes: 'Best general-purpose zone map LoRA. Keep weight ≤0.5 with ControlNet 0.88–0.92.',
    },
    {
        id: 'topdown-scifi',
