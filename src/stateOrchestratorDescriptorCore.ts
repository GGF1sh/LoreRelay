...
export const LEDGER_DESCRIPTORS: readonly LedgerDescriptor[] = [
    ...
    },
    {
        ...
        backupPolicy: 'none',
        circuitBreaker: 'none',
        notes: 'Also touched by mobileBaseTurnOps.ts for linked settlement moves.',
    },
    {
        id: 'world_state',
        owner: 'world_state',
    ...
    },
    {
        ...
        circuitBreaker: 'none',
        notes: 'WI7 explicit user-confirmed v0->v1 write-back with strict pre-write backup.',
    },
    {
        ...
        backupPolicy: 'strict_timestamped',
        circuitBreaker: 'none',
        notes: 'WI7b manual restore from WI7 migration backups with pre-restore backup.',
    },
];
